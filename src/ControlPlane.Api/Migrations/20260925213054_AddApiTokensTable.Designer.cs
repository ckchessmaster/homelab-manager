...
namespace ControlPlane.Api.Migrations
{
    ...
    [Migration("20260925213054_AddApiTokensTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ControlPlane.Api.Storage.Entities.ApiToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("api_tokens", "controlplane");
                });
            ...
            modelBuilder.Entity("ControlPlane.Api.Storage.Entities.ClusterLease", b =>
                {
                    ...
                    b.ToTable("cluster_leases", "controlplane");
                });
            ...
            modelBuilder.Entity("ControlPlane.Api.Storage.Entities.StepLog", b =>
                {
                    ...
                    b.ToTable("step_logs", "controlplane");
                });
            ...
            modelBuilder.Entity("ControlPlane.Api.Storage.Entities.SystemSetting", b =>
                {
                    ...
                    b.ToTable("system_settings", "controlplane");
                });
            ...
            modelBuilder.Entity("ControlPlane.Api.Storage.Entities.UpdateJob", b =>
                {
                    ...
                    b.ToTable("update_jobs", "controlplane");
                });
