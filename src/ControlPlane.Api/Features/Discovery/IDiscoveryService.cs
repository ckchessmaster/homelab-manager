...
{
    Task<DiscoveryScanResult> ScanAsync(bool includeProxmox = true, bool includeKubernetes = true, bool includeUniFi = true, bool includeOPNsense = true, CancellationToken ct = default);
