...
API Selector labels
*/}}
{{- define "controlplane.api.selectorLabels" -}}
app.kubernetes.io/name: {{ include "controlplane.name" . }}-api
app.kubernetes.io/instance: {{ .Release.Name }}
...
app.kubernetes.io/name: {{ include "controlplane.name" . }}-frontend
app.kubernetes.io/instance: {{ .Release.Name }}
...
{{- printf "%s-config" (include "controlplane.fullname" .) }}
{{- end }}
